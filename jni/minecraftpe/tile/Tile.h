...
public:
	...
	static Tile *getLightEmission(unsigned  char);
	...
	void transformToValidBlockId(unsigned char);
	void transformToValidBlockId(unsigned char, int, int, int);
};
